    ...
    const People1Page_1 = () => (
      <Block id="Test1Page-1" background="light" layout="Column" align="left">
        {[
          ...
          {
            title: '',
            content: '玉如的爸爸在她12歲生病去世，媽媽也在她18歲時，因意外過世，媽媽曾經是她最親近的人，雖然玉如也有兄弟姊妹，但玉如跟哥哥的關係一直都不太好，實習的時候跟哥哥和弟弟住在一起，卻常常和哥哥吵架，儘管如此，玉如心裡還是希望有一天能和哥哥修復關係，希望和哥哥關係變好的同時，卻又不想面對，這樣矛盾的心理，框住了玉如，也是玉如心裡缺角的一塊。',
          },
          {
            title: '',
            content: '在出現妄想的精神症狀前，玉如曾經在醫院、診所、養老院擔任護士，但是每份工作都沒有持續多久，因為每當玉如面對情況嚴重的病人，都會想起以前爸爸器官衰竭，躺在病床上，而她卻沒辦法為爸爸做些甚麼，當時的記憶彷彿重現一般，難過與焦慮再度浮現，讓玉如承受著過大的心理壓力，覺得自己沒有能力處理緊急狀況，也就因此辭職。',
          },
          {
          ...
          {
            title: '',
            content: '6年前，玉如在診所上班，那是她第一次出現妄想症狀，也是她第一次住院，玉如曾經住院三次，第二次住院長達九個月，對玉如來說，住院讓她感到安全，玉如說：「一個房間會有兩個室友陪我，很像以前念專科、念護校的時候，我覺得很有趣、很好玩。」白天醫院的職能治療活動，有手作課、英文課等等，也讓玉如樂在其中。雖然玉如在住院這段日子大多都很快樂，但她也說，「比較重要的是出院以後的生活和面對壓力的調適方法。」出院後才是面對疾病、跟疾病共處的練習。',
          },
          {
            title: '',
            content: '在第二次出院以後，玉如很積極的查找資料，每天都在學習面對自己的精神症狀，幾年前，玉如在網路上找到《新北市康復之友協會》附設的新莊工作坊，她發現那裡是一個專門提供受精神症狀所苦的人協助的機構，後來玉如成了工作坊學員的一份子，經常到工作坊上課、做心理衛教，而後來玉如的狀況漸漸穩定，主任也邀請玉如留在工作坊擔任護理師，帶著自己的經驗去幫助其他學員。'},
          {
            title: '',
            content: '玉除了在工作坊擔任護理師，玉如也曾在其他地方打工，她的上一份工作是在pizza店上班，應徵的時候玉如告訴店長自己有思覺失調症，反應跟學習能力會比較慢，雖然店長說沒關係，但在工作時，店長沒有特別體諒她，玉如心裡一方面覺得店長把她當成一般人，沒有放低標準對她是件好事，但另一方面卻也覺得自己因為精神症狀，導致工作狀態不好的時候，沒有被接納與寬容，力不從心的感覺讓她失落難過，而這也讓她的壓力越來越大，精神症狀嚴重到出現妄想，在跟醫生討論過後，為了避免再次嚴重發病使腦部功能受影響，玉如最後只能辭職。',
          }
        ]}
      </Block>
    );
    ...
    const People1Page_2 = () => (
      <Block id="Test1Page-2" background="light" layout="Column" align="left">
        {[
          {
            title: '陪伴是最好的支持',
            content: '玉如平常喜歡跟姊姊一家人、好朋友們在一起，「跟讓我有安全感的人互動，有互動、支持，就比較不會情緒低落。」玉如說。在沒有工作影響的時候，玉如會去姐姐家，和姐姐一起準備大家的晚餐，姐姐有兩個小孩，玉如都叫他們「花生兄妹」，跟姊姊一家人在一起，讓玉如的心有了歸屬感而不孤單。 '
          },
          {
            title: '',
            content: '玉如有一個很好的朋友，是以前工作認識的學姐，心情不好的時候，也常常會和學姐一起去逛街、唱歌、看電影，有時候也會一起去教會，玉如自己也說：「其實跟一般人紓壓的方式很像。」'
          },
          {
            title: '',
            content: '現在玉如為自己設立了短期目標，她希望可以持續的在工作坊工作，打破自己以前一份工作無法長久做下去的紀錄，同時她一直在努力與學習的，依然是和自己的精神症狀共處。'
          }
        ]}
      </Block>
    );
    ...
    const People2image = () => (
      <Block id="Test2image" layout="twoColumn" background="light">
        {[
          {
            title: '宗辰｜與強迫症共處15年',
            content: '在Easy Coffee工作的時候，宗辰口中唸唸有詞，總會小聲提醒自己接下來要做甚麼，他的動作很快，不完全是敏捷的那種迅速，感覺他很急，急著做好每一件事，那看似是一種焦躁的精神症狀，慢慢觀察之後發現，其實宗辰做每個動作的時候，既冷靜、且確實，想必這是他這十幾年的練習與經驗。不論是工作或是面對精神症狀，經過練習，還有時間的累積，總是會漸漸平緩、漸漸熟稔。',
    ...
    const People2Page_1 = () => (
      <Block id="Test2Page-1" className="Test2Page" layout="Column" background="light" align="left">
        {[
          {
            title: '讀書時期的發病徵兆',
            content: '15年前宗辰在美國念書，是親戚發現了他的精神症狀，「有時候我會待在房間，或者是廁所，會很久這樣子，覺得頭腦不太好控制。」宗辰說，他發現自己越來越不能專心，總是會不自覺的想事情，這一想可能十分鐘就過去了，當他回過神來，並試著把思緒拉回來時，沒多久頭腦卻又會被另一件事佔據，同時他也會像是凍結一般，停止當時正在做的事。'
          },
          {
            title: '',
            content: '「我可能比較，白就是白，黑就是黑阿，沒有甚麼灰色地帶。」宗辰自己分析著他的個性，他高中一畢業就去到美國，個性內向的他，在人生地不熟的國家裡，只要和別人說話的時候，感受到對方的不耐煩，宗辰就會一直把它放在心上，「那時候我可能會一直記在心裡，不太懂得怎麼去解決這方面阿。」宗辰回想那時候的自己，比較在意別人，也比較敏感，讓當時的情緒一直沒辦法消化。'
          },
          {
            title: '',
            content: '一開始宗辰不知道這些就是精神症狀，但後來他發現自己很容易累、睡覺的時間變長、生活作息變得不一樣，這些症狀漸漸變得嚴重，影響到他本來的生活，住在宗辰附近的親戚也發現，宗辰的精神狀況和以前不一樣，建議他先回台灣休養，回台灣看診，聽醫生說了以後，宗辰才知道，原來像他這樣常常陷入沒有意義的思考，是強迫症的一種精神症狀。'
          },
          {
            title: '接觸心理諮商',
          },
          ...
          {
            title: '',
            content: '宗辰與爸媽的感情很好，雖然宗辰因為精神症狀的影響，被迫暫停學業，但宗辰的爸媽沒有責怪，而是很認真地去了解這些精神症狀，試圖去理解宗辰的想法，「他們還是會去了解這個病阿，會去上網找資料，不會說一般刻板印象，要去收驚之類的。」宗辰說著爸媽對他的諒解，眼眶也跟著泛了淚。 '
          },
          {
            title: '',
            content: '幾年前，宗辰的爸爸建議他去做心理諮商，「他就是覺得我太快啦，叫我放慢腳步。」宗辰說著諮商師給他的建議，「每天睡覺前阿，就是叫我要深呼吸。」那是為了讓自己放慢動作，諮商師建議，宗辰每天睡覺前可以做二十分鐘的呼吸練習，先吸氣，吐氣的時候慢慢的吐，延長吐氣時間到三十秒，經過這個練習，宗辰也發現到稍微放慢速度，的確會感覺比較放鬆。 '
          },
          {
            title: '',
            content: '在諮商的過程中，宗辰也發現了自己的性格是精神症狀出現的原因之一，宗辰說，以前在美國的時候，他也常常會想起新聞播報的社會事件，因為宗辰有正義感的性格，讓他對這些事無法釋懷，但諮商師曾提醒宗辰，「很多東西不太可能分的那麼清楚，總是會有灰色地帶阿。」諮商師建議他，可以試著培養自己的興趣，透過把注意力放在自己喜歡的東西上，去避開討厭的人事物。'
          }
        ]}
      </Block>
    );
    ...
    const People2Page_2 = () => (
      <Block id="Test2Page-2" layout="Column" background="light" align="left">
        {[
          ...
          {
            title: '',
            content: '問起宗辰覺得自己和以前有什麼不一樣，他說，「比較有愛心吧，比較有同理心，就是比較會去幫助人家吧。」雖然沒有人希望自己有精神症狀，但宗辰還是接受了現在的自己，找到了新的生活方式，問他有沒有一些建議可以分享給正為精神症狀困擾的人，他說，「要有病識感吧，不要去抗拒啊！」對於精神症狀，去面對、不逃避，可能就是精神疾病唯一的解答。'
          }
        ]}
      </Block>
    );
